...
class FootballersController < ApplicationController
  ...
  def show
    ...
    tournaments = @footballer.footballers_teams.joins(:step).group("steps.tournament_id, footballers_teams.footballer_id, footballers_teams.team_id, footballers_teams.step_id").collect{|item| item.step.tournament}
