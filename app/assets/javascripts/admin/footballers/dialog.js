Ext.namespace("FootballerDialog");
FootballerDialog = Ext.extend(Ext.Window, {
    ...
    Ext.apply(this, {
      form: new Ext.form.FormPanel({
                      ...
                      items: [
                        {
                          fieldLabel: 'Имя',
                          name: 'footballer[first_name]',
                          anchor:'100%'  // anchor width by percentage
                        }
                        ,{
                          fieldLabel: 'Фамилия',
                          name: 'footballer[last_name]',
                          anchor: '100%'  // anchor width by percentage
                        }
                        ,{
                          fieldLabel: 'Отчество',
                          name: 'footballer[patronymic]',
                          anchor: '100%'  // anchor width by percentage
                        }
                      ]
                  })
...
//    window.show();
    ...
    FootballerDialog.superclass.initComponent.apply(this, arguments);
  }
  ,saveItem: function() {
...
Ext.reg("footballerdialog", FootballerDialog);